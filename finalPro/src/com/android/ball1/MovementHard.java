...
public class MovementHard extends Activity {
	int sound,high,bestScore;
	public static String filename = "bestScoreFile3";
	SharedPreferences data;
    @Override
	public void onBackPressed() {
		
		super.onBackPressed();
		Intent in = new Intent(MovementHard.this,NewGame2.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mv.t = new CountDownTimer(30000, 1000) {
			...
			public void onFinish() {
				...
				AlertDialog alert = new AlertDialog.Builder(MovementHard.this).create();
				...
				alert.setButton2("Post your success to facebook?", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface arg0, int arg1) {
						...
						/*Intent in = new Intent(MovementHard.this,PostOnFb.class);
						in.putExtra("points", mv.points);
						in.putExtra("gametype", "classic tough");
						in.putExtra("sound", sound);
						startActivity(in);
						overridePendingTransition(R.anim.fadein, R.anim.fadeout);
						finish();*/
