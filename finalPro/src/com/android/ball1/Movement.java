...
public class Movement extends Activity {
	...
	public static String filename = "bestScoreFile";
	SharedPreferences data;
	@Override
	public void onBackPressed() {
		
		super.onBackPressed();
		Intent in = new Intent(Movement.this,NewGame2.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tv.setTextColor(Color.BLUE);  tv.setBackgroundColor(Color.GREEN);
        tv.setTextColor(Color.WHITE);
        tv.setTextSize(20);
        
        bestScore = data.getInt("best", 0);
        sound = getIntent().getExtras().getInt("Sound");
        mv=new MovementView(this);
        if(sound==1){
        	mv.play = 1;
        }
        else{
        ...
        mv.t = new CountDownTimer(30000, 1000) {
			...
			public void onFinish() {
				...
				editor.commit();
				AlertDialog alert = new AlertDialog.Builder(Movement.this).create();
				...
				alert.setButton2("Post your success to facebook?", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface arg0, int arg1) {
						...
						/*Intent in = new Intent(Movement.this,PostOnFb.class);
						in.putExtra("points", mv.points);
						in.putExtra("gametype", "Easy");
						startActivity(in);
						overridePendingTransition(R.anim.fadein, R.anim.fadeout);
						finish();*/
					}
