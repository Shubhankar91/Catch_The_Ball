...
public class TopsyTurvyView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    UpdateThreadTopsyTurvy updateThread,updateThread2;
    public TopsyTurvyView(Context context) {
        super(context);
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        xPos = ran;
        yPos = ran;
        updateThread = new UpdateThreadTopsyTurvy(this);
        updateThread.setRunning(true);
        updateThread.start();
        
        xPos2 = width/2;
        yPos2 = circleRadius;
        updateThread2 = new UpdateThreadTopsyTurvy(this);
