...
public class splashthreeball extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		t=new CountDownTimer(1000,1000) {
			...
			public void onFinish() {
				...
				Intent in = new Intent(splashthreeball.this, MovementThreeBall.class);
	...
	public void onBackPressed() {
		...
		super.onBackPressed();
		t.cancel();
		Intent in = new Intent(splashthreeball.this,NewGame2.class);
		overridePendingTransition(R.anim.fadein, R.anim.fadeout);
		startActivity(in);
		finish();
	}
