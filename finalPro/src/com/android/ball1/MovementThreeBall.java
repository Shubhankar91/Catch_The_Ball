...
public class MovementThreeBall extends Activity {

	MovementViewThreeBall mv;
	int sound,high,bestScore;
	public static String filename = "bestScoreFileThreeBall";
	SharedPreferences data;
	@Override
	public void onBackPressed() {
		
		super.onBackPressed();
		Intent in = new Intent(MovementThreeBall.this,NewGame2.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mv=new MovementViewThreeBall(this);
        if(sound==1){
        	mv.play = 1;
        }
        else{
        ...
        mv.t = new CountDownTimer(45000, 1000) {
			...
			public void onFinish() {
				...
				editor.commit();
				AlertDialog alert = new AlertDialog.Builder(MovementThreeBall.this).create();
				...
				alert.setButton2("Post your success to facebook?", new DialogInterface.OnClickListener() {
					...
					/*	Intent in = new Intent(MovementThreeBall.this,PostOnFb.class);
						in.putExtra("sound", sound);
						in.putExtra("points", mv.points);
						in.putExtra("gametype", "Three Bust");
						startActivity(in);
						overridePendingTransition(R.anim.fadein, R.anim.fadeout);
						finish();*/
					}
