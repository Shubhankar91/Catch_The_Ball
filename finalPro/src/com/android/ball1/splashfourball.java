...
public class splashfourball extends Activity {
...
t=new CountDownTimer(1500,1000) {
			...
			public void onFinish() {
				...
				Intent in = new Intent(splashfourball.this, MovementFourBall.class);
	...
	public void onBackPressed() {
		...
		super.onBackPressed();
		t.cancel();
		Intent in = new Intent(splashfourball.this,NewGame2.class);
		overridePendingTransition(R.anim.fadein, R.anim.fadeout);
		startActivity(in);
		finish();
	}
